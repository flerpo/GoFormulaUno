...
func GetConnection() *gorm.DB {
	...
	db, err := gorm.Open("mysql", "formula:sofarfromhome@tcp(172.17.0.2:3306)/formula?charset=utf8&parseTime=True")
	// db, err := gorm.Open("mysql", "formula:sofarfrompassword@tcp(35.241.190.209:3306)/formula?charset=utf8&parseTime=True")
